...
Historical work is undergoing a second controlled reconciliation pass, working backwards through the archive in small chronological blocks. The current review frontier has reached **September 2020**. The 2021 historical block is fully reviewed month by month, and the same controlled pass is now progressing through 2020.
