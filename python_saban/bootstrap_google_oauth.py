...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create the dedicated Gmail/Drive/Sheets OAuth credential for LITOS Saban intake."
    )
    parser.add_argument("client_secret_json", help="Path to the OAuth Desktop client JSON downloaded from Google Cloud")
    parser.add_argument(
        "--out",
        default="google_oauth_saban.json",
    ...
    credentials = flow.run_local_server(
        ...
        access_type="offline",
        prompt="consent",
        authorization_prompt_message="Open this URL in your browser to authorize LITOS Saban intake:\n{url}",
        success_message="LITOS Saban authorization completed. You can close this browser tab.",
    )
    ...
    print("Do NOT commit this file. Store it as the GitHub Actions secret GOOGLE_OAUTH_SABAN_JSON.")
    return 0
