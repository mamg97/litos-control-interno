...
def build_user_services() -> Services:
    """Build Drive/Sheets services from the user's OAuth refresh credential.

    The credential is supplied only through the GitHub Actions secret
    GOOGLE_OAUTH_USER_JSON. It is never committed to the repository.
    """
